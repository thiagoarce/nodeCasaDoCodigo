...
var delegateEvent = eventDelegation._V_;
var getEventFromEl = eventDelegation._W_;
...
function handleNodeAttach(node, componentsContext) {
    if (node.nodeType === 1) {
        ...
        if (target) {
            ...
            var attachTargets = data._X_;
            if (!attachTargets) {
                attachTargets = data._X_ = [];
                out.on("_O_", function () {
...
eventDelegation._Y_ = handleNodeAttach;
