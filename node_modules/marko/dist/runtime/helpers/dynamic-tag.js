...
module.exports = function dynamicTag(out, tag, getAttrs, renderBody, args, props, componentDef, key, customEvents) {
    if (tag) {
        ...
        if (typeof tag === "string") {
            ...
            if (renderBody) {
                out.aJ_(tag, attrs, key, component, 0, 0, props);
                renderBody(out);
                out.aK_();
            } else {
            ...
            if (tag._ || tag.renderer || tag.render) {
                ...
                if (isFn) {
                    ...
                    out.aM_(key, component, preserve);
                    if (!isW10NOOP && isFn) {
        ...
        out.aM_(key, component, IS_SERVER ? compFlags & FLAG_WILL_RERENDER_IN_BROWSER : render === w10NOOP);
        renderBody(out);
        out.aN_();
    }
};